...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post values_url, params: { value: { image_id: @value.image_id, iser_id: @value.iser_id, value: @value.value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { image_id: @value.image_id, iser_id: @value.iser_id, value: @value.value } }
